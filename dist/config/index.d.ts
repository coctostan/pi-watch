 ...
 */
export { resolveWatchConfig, type WatchConfig, type LocalAsrConfig, DEFAULT_BUDGET, DEFAULT_RESOLUTION, DEFAULT_FETCH_TIMEOUT_MS, DEFAULT_LOCAL_ASR_EXECUTABLE, DEFAULT_LOCAL_ASR_MODEL, DEFAULT_LOCAL_ASR_MAX_DURATION_MS, DEFAULT_LOCAL_ASR_TIMEOUT_MS, MAX_LOCAL_ASR_DURATION_MS, MAX_LOCAL_ASR_TIMEOUT_MS, } from "./config.js";
