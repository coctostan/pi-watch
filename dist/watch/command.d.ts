...
export declare const WATCH_COMMAND_USAGE = "Usage: /watch <video-path-or-url> <question>";
/**
 ...
 */
export declare function buildWatchPrompt(ref: string, question: string): string;
/**
 ...
 * notify an error.
 */
export declare function runWatchCommand(args: string, effects: WatchCommandEffects): void;
