 ...
 */
export declare function buildTier2Request(set: WatchedFrameSet, question: string, config: Tier2Config): {
    url: string;
    init: RequestInit;
};
/**
 ...
 */
export declare function parseTier2Answer(json: unknown): string | null;
/**
 ...
 */
export declare const LOCAL_TIER2_BASE_URL = "http://localhost:8080/v1";
export declare const LOCAL_TIER2_MODEL = "mlx-community/Qwen3-VL-8B-Instruct-4bit";
/**
 ...
 */
export declare const TIER2_UNCONFIGURED_HINT: string;
/**
 ...
 */
export declare function resolveTier2ConfigFromEnv(env?: NodeJS.ProcessEnv): Tier2Config | null;
/** The distinct tier-2 failure modes surfaced as diagnostics (DESIGN.md §4 / Phase 12). */
export type Tier2FailureReason = "unconfigured" | "http-error" | "empty-answer" | "timeout" | "network-error";
/**
 ...
 */
export declare function createTier2Runner(deps?: {
