...
- **OCR resolution composition (R3/F2):** question-derived high resolution is currently computed after sampling; preserve the requirement and route the implementation correction through the M4 audit.
